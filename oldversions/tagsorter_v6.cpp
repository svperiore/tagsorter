    ...
    do{
        ...
        else if(functionselect == 1)//read input.txt
        {
            ...
            while(!inFS.eof())//gather all codes from sauce.txt
            {
                ...
                if(linenumber == 0 || linenumber%12 == 0)
                {
        ...
        else if(functionselect == 2)//search function
        {
            ...
            if(inFS.is_open())//opens file
            {
                ...
                cout << "Found " << matches << " matches out of " << numofwork << " total works..." << endl;
        ...
        else if(functionselect == 3)//show more info 
        {
                    ...
                    if(check == 1)
                    {
                        while(!inFS.eof())
                        {
                            ...
                            if(tempdisplay[2] == tempcodes[i-1])
                            {
                                ...
                                tempstring = "D:/sebas/Documents/tagsorter/images/" + tempcodes[i-1] + paste; 
            ...
            {
                cout << "Perform a valid prior to using this function" << endl;
            }
            cin >> functionselect;
        }
        ...
        else if(functionselect == 5)//help screen
        {
            ...
            cout << ">Because of the way characters are stored, Japanese text will look screwy (can't be bothered to fix this :P )" << endl;
