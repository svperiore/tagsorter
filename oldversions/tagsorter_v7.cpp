...
//need to fix the n/a issue (do we really though?)
...
int main()
{
    ...
    do{
            ...
            if(inFS.is_open())//Opens file
            {
                ...
                if(check1 > 0)
                {
                    while(!inFS.eof())
                    {
                        ...
                        {
                            cout << "code was found" << endl;
                            cout << tempdisplay[2] << " is the same as " << tempcodes[i] << endl;
                            ...
                            tempstring = "D:/sebas/Documents/tagsorter/images/" + tempdisplay[2] + paste; 
        ...
        else if(functionselect == 4)//show collections
        {
            ...
            if(inFS.is_open())//opens file
            {
                ...
                if(check1 == 1)
                {
                    ...
                    cout << "Found " << mokuteki << " unique items across " << numofwork << " work(s)..." << endl << "Type 0 to quit" << endl << "Type 1 to view by most popular" << endl << "Type 2 to view in alphabetical order" << endl;
                    cin >> functionselect;
        ...
        else if(functionselect == 5)//help screen
        {
            ...
            cout << ">After making a search, input the number corresponding to the code of a work to see the full entry as logged in sauce.txt" << endl;
            cout << ">You can also type 0 beforehand to make a manual search. This will display the info of whatever work you type the code of" << endl;
